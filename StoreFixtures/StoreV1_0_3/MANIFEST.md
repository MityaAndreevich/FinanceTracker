# Fixture: store as written by 1.0.3 (build 7)

**Evidence about a released binary, not a store we constructed.** Generated by
`scripts/capture-store-fixture.sh v1.0.3-build7 V1_0_3`.

| | |
|---|---|
| commit | `0c328f0` — chore(release): bump build to 7 for 1.0.3 submission |
| commit date | 2026-07-27 21:43:26 +0300 |
| marketing version | `1.0.3` (build 7) |
...
- To re-derive: `FORCE=1 scripts/capture-store-fixture.sh v1.0.3-build7 V1_0_3`.
