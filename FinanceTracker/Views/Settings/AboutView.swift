...
struct AboutView: View {
    ...
    /// Internal, not private: `AppStoreLinkTests` pins the ID (D7 shipped `idTBD` for four versions).
    static let appStoreURL = URL(string: "https://apps.apple.com/app/budget-crab/id6784424678")!
