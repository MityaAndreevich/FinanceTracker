...
- The **iPhone model** and **iOS version** you're on (Settings → General → About).
...
Tap the **+ button** at the bottom of the main screen. Pick **Expense** or **Income**, enter the amount, choose a category, and tap **Save**. Returning users see prefilled fields for common transactions — most additions take about 3 seconds.
...
- **Monthly:** $2.99/month
- **Yearly:** $19.99/year with a free 7-day trial
- **Lifetime:** $59.99 one-time, every future Premium feature included

### How do I restore a previous purchase?

If you've previously bought Premium and need to restore it (after reinstalling the app, or on a new device signed in with the same Apple ID), open the app and go to **Settings → Premium → Restore Purchases**. The "Restore Purchases" button is also visible on the paywall screen.
...
Yes. Your data is yours. In **Settings → Export Data**, you can export all your transactions to a CSV file. This file works in Excel, Google Sheets, Numbers, or any other finance app that supports CSV.

### Where is my data stored?

On your iPhone, in the app's protected storage area. iOS encrypts your app data with the same protection used for Messages and Health. We do not have a server, so we do not have a copy of your data. If you turn on iCloud sync (Premium feature, post-launch update), your data syncs through your private iCloud account — it still doesn't pass through any server we control.

### I think I found a bug. What should I do?

Email me at the address above with the details and a screenshot if possible. I read every report and ship fixes weekly. If the bug affects you and others, I'll prioritize it.
...
- [Terms of Service](./TERMS.html) *(coming with v1 launch)*
